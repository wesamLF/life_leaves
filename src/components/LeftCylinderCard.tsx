...
const LeftCylinderCard = () => {
    return (
        <div className=" flex justify-start px-2 md:px-0">
            <div className=" p-3 bg-primary sm:w-[100%] md:w-[85%] lg:w-[70%]  flex flex-col-reverse items-center md:flex-row
            rounded-tr-full rounded-tl-full rounded-br-none
            md:rounded-tl-none  md:rounded-tr-full md:rounded-br-full">
...
export default LeftCylinderCard